    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden relative z-[999] p-2 rounded-full bg-primary/10 text-primary hover:bg-primary/20 transition-colors"
        ...
        <div 
          className={cn(
            "fixed inset-0 bg-black/50 backdrop-blur-sm z-[997] transition-opacity duration-300 md:hidden",
        ...
        <div
          className={cn(
            'fixed inset-y-0 right-0 w-[75%] max-w-[280px] bg-white shadow-2xl overflow-y-auto z-[998] transform transition-transform duration-300 ease-out-expo md:hidden border-l border-primary/10',
